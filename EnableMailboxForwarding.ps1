<#
EnableMailboxForwarding method for Termination Module
#>

Function Enable-MailboxForwarding {
    ...
    if ($ManagerEmailAddress -ne "None") {

        try {
            Set-Mailbox -Identity $Mailbox.Name -ForwardingAddress $ManagerEmailAddress -DeliverToMailboxAndForward $true -WarningAction SilentlyContinue -ErrorAction Stop
            ...
            $Termination.AddErrorLog($ErrorLog)
