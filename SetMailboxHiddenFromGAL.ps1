<#
SetMailboxHiddenFromGAL method for Termination Module
#>
...
Function Set-MailboxHiddenFromGAL {
    ...
    try {
        Set-Mailbox -Identity $Mailbox.Name -HiddenFromAddressList $true -WarningAction SilentlyContinue -ErrorAction Stop
