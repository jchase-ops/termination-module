<#
RemoveInboxRules method for Termination Module
#>
...
Function Remove-InboxRules {
    ...
    try {
        Get-InboxRule -Mailbox $Mailbox.Name -WarningAction SilentlyContinue -ErrorAction Stop | Remove-InboxRule -Force -Confirm:$false -WarningAction SilentlyContinue -ErrorAction Stop
