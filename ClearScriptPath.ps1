<#
ClearScriptPath method for Termination Module
#>

Function Clear-ScriptPath {
    ...
    if ($null -ne $Account.ScriptPath) {
        try {
            Set-ADUser -Identity $Account.SamAccountName -Clear ScriptPath -Server $DomainControllers.$Domain.Name -Credential $Credential
