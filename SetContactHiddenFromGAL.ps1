<#
SetContactHiddenFromGAL method for Termination Module
#>

Function Set-ContactHiddenFromGAL {
    ...
    try {
        Get-MailContact -ANR $Mailbox.Alias | Set-MailContact -HiddenFromAddressListsEnabled:$true -ForceUpgrade -WarningAction SilentlyContinue -ErrorAction Stop
